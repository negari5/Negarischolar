...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'landing_hero_subtitle': 'AI-powered scholarship companion guiding Ethiopian students from Grade 8 to global opportunities.',
    'welcome': 'Welcome',
    ...
    'landing_path_jr_desc': 'Early preparation tools for middle school students (Grades 8-10)',
    'landing_path_starter_title': 'Starter Kit',
    'landing_path_starter_desc': 'Perfect for Grade 11-12 students beginning their scholarship journey',
    ...
    'landing_path_rise_desc': 'A second door for students who didn’t pass Grade 12 real skills, scholarships, and new university options.',
    ...
    'landing_ai_interview_prep': 'Interview Prep',
    ...
    'landing_feature_ai_essay_coach_title': 'Essay Coach',
    'landing_feature_ai_essay_coach_desc': 'Get personalized feedback on your scholarship essays with Powered writing assistance',
    ...
    'plan_feature_ai_essay_coach': 'Essay coach',
  ...
  am: {
    ...
    'landing_hero_subtitle': 'ከ8ኛ ክፍል ጀምሮ የኢትዮጵያ ተማሪዎችን ወደ ዓለም አቀፍ እድሎች የሚመራ በAI የተጎላበተ የስኮላርሺፕ ጓደኛ።',
    'welcome': 'እንኳን ደህና መጡ',
    'scholarships': 'ስኮላርሺፕ',
    'mentors': 'አማካሪዎች',
    ...
    'landing_path_jr_title': 'Jr.',
    'landing_path_jr_desc': 'ለመካከለኛ ት/ቤት ተማሪዎች (8-10) የቅድመ ዝግጅት መሳሪያዎች',
    'landing_path_starter_title': 'Starter Kit',
    'landing_path_starter_desc': 'ለ11-12 ክፍል ተማሪዎች የስኮላርሺፕ ጉዞ መጀመሪያ',
    'landing_path_senior_title': 'Senior',
    ...
    'landing_ai_interview_prep': 'የቃለ-መጠይቅ ዝግጅት',
    ...
    'landing_feature_ai_essay_coach_title': 'የኤሴ አማካሪ',
    'landing_feature_ai_essay_coach_desc': 'የተጎላበተ የጽሁፍ እገዛ ጋር ለኤሴዎ የግል ግብረ መልስ ያግኙ',
    ...
    ,
    'landing_story_1_quote': 'የነጋሪ የኤሴ አማካሪ አሸናፊ የስኮላርሺፕ ኤሴ ለመጻፍ እጅግ ረዳኝ። በካናዳ ለመማር ሙሉ ስኮላርሺፕ አግኝቻለሁ!',
    ...
    'plan_feature_ai_essay_coach': 'የኤሴ አማካሪ',
    ...
    'sub_path_junior_title': 'Negari Junior',
    'sub_path_junior_subtitle': '8-10ኛ ክፍል',
    'sub_path_junior_desc': 'የቅድመ ዝግጅት እና መሠረት መገንባት',
    'sub_path_starter_title': 'Starter Kit',
    'sub_path_starter_subtitle': '11-12ኛ ክፍል',
  ...
  om: {
    ...
    'landing_hero_subtitle': 'Hirmaataa scholarships powered kan barattoota Itoophiyaa Kutaa 8 irraa kaasee gara carraa addunyaatti qajeelchu.',
    ...
    'landing_path_jr_title': 'Jr.',
    'landing_path_jr_desc': 'Meeshaalee qophii duraa barattoota sadarkaa giddugaleessaa (Kutaa 8-10)f',
    'landing_path_starter_title': 'Starter Kit',
    'landing_path_starter_desc': 'Barattoota Kutaa 11-12 kan imala scholarship isaanii jalqabaniif baay\'ee mijataa',
    'landing_path_senior_title': 'Senior',
    ...
    'landing_ai_interview_prep': 'Qophii interview',
    ...
    'landing_feature_ai_essay_coach_title': 'Gorsaa essay',
    'landing_feature_ai_essay_coach_desc': 'Deeggarsa barreessuu waliin, essay scholarship keef yaada-deebii dhuunfaa argadhu',
    ...
    'landing_story_1_quote': 'Gorsaan essay kan Negari, essay scholarship koo mo\'ataa barreessuuf na gargaare. Kanaadaa keessatti injinariingii barachuuf scholarship guutuu argadhe!',
    ...
    'plan_feature_ai_essay_coach': 'Gorsaa essay',
    ...
    'sub_path_junior_title': 'Negari Junior',
    'sub_path_junior_subtitle': 'Kutaa 8-10',
    'sub_path_junior_desc': 'Qophii duraa fi bu\'uura ijaaruu',
    'sub_path_starter_title': 'Starter Kit',
    'sub_path_starter_subtitle': 'Kutaa 11-12',
  ...
  ti: {
    ...
    'landing_hero_subtitle': 'ካብ 8ይ ክፍሊ ጀሚሩ ተመሃሮ ኢትዮጵያ ናብ ዓለማዊ ዕድላት ዝመርሕ ብዝተጎላበተ መሓዛ ስኮላርሺፕ።',
    ...
    'landing_path_jr_title': 'Jr.',
    'landing_path_jr_desc': 'ንተመሃሮ መካከለኛ ት/ቤት (ክፍሊ 8-10) ዝተዳለወ ኣቐዲሙ ምድላው መሳርሒታት',
    'landing_path_starter_title': 'Starter Kit',
    'landing_path_starter_desc': 'ንተመሃሮ ክፍሊ 11-12 ጉዕዞ ስኮላርሺፕ ዝጀምሩ ብጣዕሚ ዝምችእ',
    'landing_path_senior_title': 'Senior',
    ...
    'landing_ai_interview_prep': 'ምድላው ቃለ-መጠይቕ ',
    ...
    'landing_feature_ai_essay_coach_title': 'መምርሒ ጽሑፍ (Essay) ',
    'landing_feature_ai_essay_coach_desc': 'ብዝተደገፈ ሓገዝ ጽሑፍ ጋር ንEssay ስኮላርሺፕካ ውልቃዊ ግብረ-መልሲ ረክብ',
    ...
    'landing_story_1_quote': 'መምርሒ ኤሴ ብናይ ነጋሪ ኤሴ ስኮላርሺፕ ዝሓሸ ንምጽሓፍ እጅግ ሓገዘኒ። ኣብ ካናዳ ምህንድስና ንምምሃር ሙሉእ ስኮላርሺፕ ረኺበ!',
    ...
    'plan_feature_ai_essay_coach': 'መምርሒ ጽሑፍ (Essay)',
    ...
    'sub_path_junior_title': 'Negari Junior',
    'sub_path_junior_subtitle': 'ክፍሊ 8-10',
    'sub_path_junior_desc': 'ኣቐዲሙ ምድላውን ምስራት መሰረትን',
    'sub_path_starter_title': 'Starter Kit',
    'sub_path_starter_subtitle': 'ክፍሊ 11-12',
